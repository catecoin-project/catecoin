...
* catecoin.conf: contains configuration settings for catecoind or catecoin-qt
* catecoind.pid: stores the process id of catecoind while running
...
* debug.log: contains debug information and general logging generated by catecoind or catecoin-qt
