...
{
    const char* pszTimestamp = "Co ja pacze";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("6078ec0526ef7055337834f3fe0f1928d843949cda17d22b3656178bbbbc921f");
        ...
        consensus.defaultAssumeValid = uint256S("0x6078ec0526ef7055337834f3fe0f1928d843949cda17d22b3656178bbbbc921f"); //1441280
        ...
        genesis = CreateGenesisBlock(1569671396, 2631093, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6078ec0526ef7055337834f3fe0f1928d843949cda17d22b3656178bbbbc921f"));
        assert(genesis.hashMerkleRoot == uint256S("0xefdb623aaa4fb8ef3dadce669bb32dd6ba6afce9ed150038c5d6b6d89cd479f4"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.catecoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.catecointools.com");
        //vSeeds.emplace_back("dnsseed.catecoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x79d171444bcac6100e1d8aec3ea3b0ee6975cbd16a04b5bae5cf16889907756f"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 1697491, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x79d171444bcac6100e1d8aec3ea3b0ee6975cbd16a04b5bae5cf16889907756f"));
        assert(genesis.hashMerkleRoot == uint256S("0xefdb623aaa4fb8ef3dadce669bb32dd6ba6afce9ed150038c5d6b6d89cd479f4"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.catecointools.com");
        //vSeeds.emplace_back("seed-b.catecoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd1a99c8e4df6c445f39daa4b72ef58f00b693e74f940f970e0a71ec1578e400a"));
        assert(genesis.hashMerkleRoot == uint256S("0xefdb623aaa4fb8ef3dadce669bb32dd6ba6afce9ed150038c5d6b6d89cd479f4"));
