...
const char * const BITCOIN_CONF_FILENAME = "catecoin.conf";
const char * const BITCOIN_PID_FILENAME = "catecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/CateCoin";
#else
    // Unix
