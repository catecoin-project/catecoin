...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s catecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  catecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded catecoin transaction") + "\n" +
              "  catecoin-tx [options] -create [commands]   " + _("Create hex-encoded catecoin transaction") + "\n" +
              "\n";
