...
"""Verify that starting catecoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start catecoin with -h for help text")
        ...
        self.log.info("Start catecoin with -version for version information")
